...
symmetry.  This assures that when you rotate on the XY plane, +90 degrees & -90 degrees rotations will yield correct results.  Bottom line
is that you have to calibrate the magnetometer in the location where it is situated - especially on the a quad copter.
